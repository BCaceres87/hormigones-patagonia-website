...
import MachineryBackground from '../assets/images/machinery_background.jpg'
import MachineryImage from '../assets/images/machinery2.jpg'
      ...
      <section className={styles.section1}>
        <Wrapper>
          <div className={styles.image_wrapper}>
            <img src={MachineryImage} alt="Hormigon image" />
          </div>
